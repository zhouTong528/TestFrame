...
class SendEmail:
    ...
    # 以文本和附件的形式发送邮件
    def send_email_by_att(self, file_path, from_address, to_address, subject='WebUI自动化测试报告',
...
if __name__ == '__main__':
    ...
    mail_user = '2299xxx'  # 登录 QQ 邮箱的QQ号
    mail_key = 'iadcbxxxx'  # 邮箱登录授权码
    sender = '22996xxx@qq.com'  # 发送邮箱地址
    receivers = ['2299xxx@qq.com', '17601xxx@163.com']  # 接收者

    email = SendEmail(mail_host, mail_user, mail_key, sender, receivers)
    email.send_email_by_text('V3.4.0版本已完成系统测试', '测试主题', '测试', '测试负责人')
